...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        let node = SCNNode()
        if let imageAnchord = anchor as? ARImageAnchor {
            ...
            let plane = SCNPlane(width: imageAnchord.referenceImage.physicalSize.width,
                                 height: imageAnchord.referenceImage.physicalSize.height)
